...
echo -e " \033[0;35m══════════════════════════════════════════════════════════════════\033[0m"
echo -e ""
echo -e "PLease Wait 5 Seconds To Start Installation"
sleep 5

startinstall(){
apt update
sudo apt install apache2 
sudo nano fail2ban unzip python build-essential curl build-essential libwrap0-dev libpam0g-dev libdbus-1-dev libreadline-dev libnl-route-3-dev libprotobuf-c0-dev libpcl1-dev libopts25-dev autogen libgnutls28-dev libseccomp-dev libhttp-parser-dev php libapache2-mod-php -y
...
wget -O autodns "https://raw.githubusercontent.com/Dexter-Hysteria/Slowdns/server_script/autodns" && chmod +x autodns && sed -i -e 's/\r$//' ~/autodns && ./autodns
...
echo ""
echo -e " \e[92m HOST DNS:\e[0m \e[97m:\e[0m" && cat /root/subdomain
echo -e " \e[92m NAMESERVER:\e[0m \e[97m:\e[0m" && cat /root/ns.txt
echo -e " \e[92m SLOWDNS PORT:\e[0m \e[97m: 442\e[0m"
